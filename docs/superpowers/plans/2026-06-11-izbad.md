...
mod tests {
    ...
    fn response_roundtrip() {
        for resp in [
            ...
            DaemonResponse::Guest { payload: Response::Ok },
            DaemonResponse::List {
...
mod tests {
    ...
    fn guest_rpc_proxies_health() {
        ...
        match rpc(
            ...
            DaemonResponse::Guest { payload: Response::Health(h) } => assert_eq!(h.version, "test"),
...
mod tests {
    ...
    fn guest_rpc_unwraps_guest_response() {
        let conn = fake_daemon("v", |mut s| {
            ...
            write_frame(&mut s, &DaemonResponse::Guest { payload: izba_proto::Response::Ok }).unwrap();
        });
        let mut c = DaemonClient::handshake(conn, "v").unwrap();
